...
export type OnboardingFlowId = 'staff-first-login'
...
export type OnboardingStepConfig = {
  ...
  stageRadius?: number
  lockPopoverPlacement?: 'top-start' | 'top-end' | 'bottom-start' | 'bottom-end'
...
export type OnboardingStepTranslator = (contentKey: string) => OnboardingStepContent

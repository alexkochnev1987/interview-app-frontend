import type { FetchQuestionFacetsParams, FetchQuestionsParams } from '@/lib/api'
...
export const questionsInfiniteQueryKey = (params: Omit<FetchQuestionsParams, 'page'>) =>
...
export const similarQuestionsQueryKey = (signature: string, excludeId: string | undefined) =>

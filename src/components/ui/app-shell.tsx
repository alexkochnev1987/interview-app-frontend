...
export function AppBody({ className, ...props }: HTMLAttributes<HTMLBodyElement>) {
  return (
    <body
...
export function AppShellRoot({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('relative flex min-h-screen overflow-x-clip', className)} {...props} />
}

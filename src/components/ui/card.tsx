  ...
  'group/card flex flex-col overflow-hidden rounded-xl text-sm text-card-foreground has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:has-data-[slot=card-footer]:pb-0 [img:first-child]:*:rounded-t-xl [img:last-child]:*:rounded-b-xl',
  {
    variants: {
      variant: {
        ...
        surface: 'border border-hairline-strong bg-surface-glass shadow-soft',
        surfaceFlat: 'border border-hairline-strong bg-surface-glass shadow-none',
      ...
      interaction: {
        ...
        'hover-glow': 'transition-all duration-200 hover:-translate-y-0.5 hover:shadow-float',
      },
      state: {
        default: '',
...
const cardContentVariants = cva('', {
  variants: {
    ...
    layout: {
      default: '',
      'fill-column': 'flex min-h-0 min-w-0 flex-1 flex-col self-stretch',
...
const cardTitleVariants = cva('font-heading font-medium group-data-[size=sm]/card:text-sm', {
  variants: {
    size: {

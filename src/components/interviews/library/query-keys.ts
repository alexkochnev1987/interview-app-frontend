import type { FetchInterviewFacetsParams, FetchInterviewsParams } from '@/lib/api'
...
export const interviewsInfiniteQueryKey = (params: Omit<FetchInterviewsParams, 'page'>) =>
